A simple HTML based eCommerce website that utilizes locastorage of web browser to add item to cart/wishlist, Json to add and fetch product and CSS to add flavor to HTML structure.
